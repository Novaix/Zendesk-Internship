...
def main():
    ...
    commands = {
    "j":lambda page: io_process.get_number( "Enter the page to jump to: ",
                                            page_max),
...
def view_ticket(return_page,login,ticket_max):
    ticket_id = io_process.get_number("Enter the id of the ticket to view: ",
                                    ticket_max)
    ...
    input("\nPress enter to return to the list of tickets.")
    return return_page
